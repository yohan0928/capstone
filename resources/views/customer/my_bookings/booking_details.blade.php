...
@section('content')
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="space-y-6">
                    ...
                    <table class="w-full min-w-[800px]">
                        <tbody class="divide-y divide-gray-200">
                            <tr>
                                ...
                                <td colspan="3" class="px-6 py-4 text-sm text-gray-600 select-text">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 text-sm text-gray-600 select-text">{{ $booking->customerAccount->email ?? 'N/A' }}
                                </td>
                                <td class="px-6 py-4 bg-gray-50 text-sm font-medium text-gray-900">Phone</td>
                                <td class="px-6 py-4 text-sm text-gray-600 select-text">
                                    {{ $booking->customerAccount->contact_no ?? 'N/A' }}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
            ...
            <!-- Basic Booking Information - WITH ACCORDION -->
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                <div class="bg-gray-50 px-6 py-4 border-b border-gray-200 flex justify-between items-center cursor-pointer accordion-toggle"
                    data-target="basic-info-accordion">
                ...
                <div id="basic-info-accordion" class="accordion-content overflow-hidden transition-all duration-300 ease-in-out"
                    style="max-height: 500px">
                    <div class="overflow-x-auto">
                        <table class="w-full min-w-[800px]">
                            <tbody class="divide-y divide-gray-200">
                                <tr>
                                    <td class="w-1/4 px-6 py-4 bg-gray-50 text-sm font-medium text-gray-900">Booking Type</td>
                                    <td class="w-1/4 px-6 py-4 text-sm text-gray-600 select-text">
                                        <span
                                            class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $booking->booking_type === 1 ? 'bg-blue-100 text-blue-800' : 'bg-green-100 text-green-800' }}">
                                            {{ $booking->booking_type === 1 ? 'Online' : 'Walk-in' }}
                                        </span>
                                    </td>
                                    <td class="w-1/4 px-6 py-4 bg-gray-50 text-sm font-medium text-gray-900">Booking Status</td>
                                    <td class="w-1/4 px-6 py-4 text-sm text-gray-600 select-text">
                                        @php
                                            $statusClass = match ($formattedData['booking_status_class'] ?? '') {
                                                'status-booked' => 'bg-blue-100 text-blue-800',
                                                'status-pending' => 'bg-yellow-100 text-yellow-800',
                                                'status-cancelled' => 'bg-red-100 text-red-800',
                                                'status-no-show' => 'bg-orange-100 text-orange-800',
                                        ...
                                        <span
                                            ...
                                            {{ $formattedData['booking_status_text'] ?? 'Unknown' }}
                                        </span>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="px-6 py-4 bg-gray-50 text-sm font-medium text-gray-900">Booking Date</td>
                                    <td class="px-6 py-4 text-sm text-gray-600 select-text">
                                        {{ $formattedData['booking_date_formatted'] ?? 'N/A' }}</td>
                                    <td class="px-6 py-4 bg-gray-50 text-sm font-medium text-gray-900">Branch</td>
                                    <td class="px-6 py-4 text-sm text-gray-600 select-text">{{ $booking->branch->branch_name ?? 'N/A' }}
                                    </td>
                                </tr>
                                <tr>
                                    <td class="px-6 py-4 bg-gray-50 text-sm font-medium text-gray-900">Room & Seat</td>
                                    <td colspan="3" class="px-6 py-4 text-sm text-gray-600 select-text">{{ $formattedData['room_seat_text'] ?? 'N/A' }}
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                    ...
                    <div id="extended-time-accordion" class="accordion-content overflow-hidden transition-all duration-300 ease-in-out"
                        ...
                        <div class="overflow-x-auto">
                            <table class="w-full min-w-[800px]">
                                <tbody class="divide-y divide-gray-200">
                                    <tr>
                                        <td class="w-1/4 px-6 py-4 bg-gray-50 text-sm font-medium text-gray-900">Extended Date
                                            Start</td>
                                        <td class="w-1/4 px-6 py-4 text-sm text-gray-600 select-text">
                                    ...
                                    <tr>
                                        <td class="px-6 py-4 bg-gray-50 text-sm font-medium text-gray-900">Extended Start Time
                                        </td>
                                        <td class="px-6 py-4 text-sm text-gray-600 select-text">
                                            {{ $formattedData['extended_start_time_formatted'] ?? 'N/A' }}</td>
                                        <td class="px-6 py-4 bg-gray-50 text-sm font-medium text-gray-900">Extended End Time
                                        </td>
                                        <td class="px-6 py-4 text-sm text-gray-600 select-text">
                                            {{ $formattedData['extended_end_time_formatted'] ?? 'N/A' }}</td>
                                    </tr>
                                    <tr>
                                        <td class="px-6 py-4 bg-gray-50 text-sm font-medium text-gray-900">Extended Time
                                            Duration</td>
                                        <td colspan="3" class="px-6 py-4 text-sm text-gray-600 select-text">
                                            <span
                                                class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-purple-100 text-purple-800">
                ...
                <div id="main-payment-accordion" class="accordion-content overflow-hidden transition-all duration-300 ease-in-out"
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full min-w-[800px]">
                            <tbody class="divide-y divide-gray-200">
                                <tr>
                                    <td class="w-1/4 px-6 py-4 bg-blue-50 text-sm font-medium text-blue-900">Payment Status
                                    </td>
                                    <td class="w-1/4 px-6 py-4 text-sm text-gray-600 select-text">
                                        @php
                                            $mainPaymentStatusClass = match (
                                                $formattedData['main_payment_status_class'] ?? ''
                                            ) {
                                    ...
                                    <td class="w-1/4 px-6 py-4 bg-blue-50 text-sm font-medium text-blue-900">Payment Method
                                    </td>
                                    <td class="w-1/4 px-6 py-4 text-sm text-gray-600 select-text">
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 text-sm text-gray-600 font-semibold select-text">
                                ...
                                @if ($mainPayment && $mainPayment->payment_method == 1)
                                    {{-- GCash --}}
                                    <tr>
                                        <td class="px-6 py-4 bg-blue-50 text-sm font-medium text-blue-900">GCash Reference No
                                        </td>
                                        <td colspan="3" class="px-6 py-4 text-sm text-gray-600 select-text">
                    ...
                    <div id="extension-payment-accordion" class="accordion-content overflow-hidden transition-all duration-300 ease-in-out"
                        ...
                        <div class="overflow-x-auto">
                            <table class="w-full min-w-[800px]">
                                <tbody class="divide-y divide-gray-200">
                                    <tr>
                                        <td class="w-1/4 px-6 py-4 bg-purple-50 text-sm font-medium text-purple-900">Payment
                                            Status</td>
                                        <td class="w-1/4 px-6 py-4 text-sm text-gray-600 select-text">
                                            @php
                                                $extensionPaymentStatusClass = match (
                                                    $formattedData['extension_payment_status_class'] ?? ''
                                                ) {
                                                    'status-paid' => 'bg-green-100 text-green-800',
                                                    'status-unpaid' => 'bg-yellow-100 text-yellow-800',
                                                    'status-invalid' => 'bg-red-100 text-red-800',
                                    ...
                                    <tr>
                                        <td class="px-6 py-4 bg-purple-50 text-sm font-medium text-purple-900">Total Amount
                                        </td>
                                        <td class="px-6 py-4 text-sm text-gray-600 font-semibold select-text">
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 bg-purple-50 text-sm font-medium text-purple-900">Payment Date
                                        </td>
                                        <td class="px-6 py-4 text-sm text-gray-600 select-text">
                                    ...
                                    @if ($extensionPayment->payment_method == 1)
                                        {{-- GCash --}}
                                        <tr>
                                            <td class="px-6 py-4 bg-purple-50 text-sm font-medium text-purple-900">GCash
                                                Reference No</td>
                                            <td colspan="3" class="px-6 py-4 text-sm text-gray-600 select-text">
            ...
            <!-- Orders Section - WITH ACCORDION (ONLY SHOW IF THERE ARE ORDERS) -->
                                        ...
                                        <table class="w-full min-w-[1000px] bg-white rounded-lg shadow-sm border border-gray-200">
                                            <thead>
                                                <tr class="bg-gray-50 border-b border-gray-200">
                                                    <th
                                                        class="px-4 py-3 text-left text-sm font-semibold text-gray-900 whitespace-nowrap">
                                                        Order Details</th>
                                                    <th
                                                        class="px-4 py-3 text-left text-sm font-semibold text-gray-900 whitespace-nowrap">
                                                        Payment Details</th>
                                            ...
                                            <tfoot>
                                                <tr class="bg-gray-50 border-t-2 border-gray-200">
                                                    <td colspan="5"
                                                        class="px-4 py-3 text-sm font-semibold text-gray-900 text-right">Total
                                                        Amount Paid:</td>
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full min-w-[800px]">
                            ...
                            <tbody class="divide-y divide-gray-200">
                                <!-- Service Payments -->
                                @php
                                    $hasServicePayments = ($mainPayment && $mainPayment->total_amount > 0) || ($extensionPayment && $extensionPayment->total_amount > 0);
                                @endphp
                                @if ($hasServicePayments)
                                    <tr class="bg-blue-50">
                                        <td colspan="3" class="px-6 py-3 text-sm font-semibold text-blue-900 uppercase">Service
                                            Payments</td>
                                    </tr>
                                    
                                    @if ($mainPayment && $mainPayment->total_amount > 0)
                                        <tr>
                                            <td class="px-6 py-4 text-sm text-gray-600 select-text">Main Service</td>
                                            <td class="px-6 py-4">
                                                <span
                                    ...
                                    @if ($extensionPayment && $extensionPayment->total_amount > 0)
                                        <tr>
                                            <td class="px-6 py-4 text-sm text-gray-600 select-text">Time Extension</td>
                                            <td class="px-6 py-4">
                                                <span
                                ...
                                <!-- Order Payments (ONLY SHOW IF THERE ARE ORDER PAYMENTS) -->
                                @php
                                    $hasOrderPayments = $hasPaidOrders || $hasUnpaidOrders;
                                    $totalOrderPayments = $totalPaidAmount + $totalUnpaidOrdersAmount;
                                @endphp
                                
                                @if ($hasOrderPayments)
                                    <tr class="bg-purple-50">
                                        <td colspan="3" class="px-6 py-3 text-sm font-semibold text-purple-900 uppercase">Order
                                            Payments</td>
                                    </tr>
                                    
                                    @if ($hasPaidOrders)
                                        <tr>
                                            <td class="px-6 py-4 text-sm text-gray-600 select-text">Paid Orders ({{ $paidOrders->count() }})
                                            </td>
                                            <td class="px-6 py-4">
                                                <span
                                                    class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">
                                    ...
                                    @if ($hasUnpaidOrders)
                                        <tr>
                                            <td class="px-6 py-4 text-sm text-gray-600 select-text">Unpaid Orders
                                                ({{ $unpaidOrders->count() }})</td>
                                            <td class="px-6 py-4">
                                                <span
                                ...
                                @php
                                    $hasServicePayments = ($mainPayment && $mainPayment->total_amount > 0) || ($extensionPayment && $extensionPayment->total_amount > 0);
                                    $totalAmount = ($totalServicePayments ?? 0) + ($totalOrderPayments ?? 0);
                                @endphp
                                
                                @if ($hasServicePayments || $hasOrderPayments)
                    ...
                    <div id="time-extension-accordion" class="accordion-content overflow-hidden transition-all duration-300 ease-in-out"
                        ...
                        <div class="overflow-x-auto">
                            <table class="w-full min-w-[800px]">
                                <tbody class="divide-y divide-gray-200">
                                    <tr>
                                        <td class="w-1/4 px-6 py-4 bg-gray-50 text-sm font-medium text-gray-900">Base Duration
                                        </td>
                                        <td class="w-1/4 px-6 py-4 text-sm text-gray-600 select-text">
                                            {{ $booking->extension->base_duration }} hour(s)</td>
                                        <td class="w-1/4 px-6 py-4 bg-gray-50 text-sm font-medium text-gray-900">Extended
                                            Duration</td>
                                        <td class="w-1/4 px-6 py-4 text-sm text-gray-600 select-text">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3" class="px-6 py-4 text-sm font-semibold text-gray-900">
                                            {{ $booking->extension->base_duration + $booking->extension->extended_duration }}
                                            hour(s)
                                        </td>
                                    </tr>
                                    <tr>
            ...
            <!-- GCash Receipts - ONLY SHOW IF THERE ARE RECEIPTS -->
            @php
                $hasMainReceipt = $mainPayment && $mainPayment->gcash_receipt_img;
                $hasExtensionReceipt = $extensionPayment && $extensionPayment->gcash_receipt_img;
                $hasAnyReceipt = $hasMainReceipt || $hasExtensionReceipt;
            @endphp
            ...
            @if ($hasAnyReceipt)
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden w-full">
                    ...
                    <div id="receipt-accordion" class="accordion-content overflow-hidden transition-all duration-300 ease-in-out">
                        <div class="p-6">
                            <div class="grid grid-cols-1 {{ $hasExtensionReceipt ? 'md:grid-cols-2' : '' }} gap-6">
