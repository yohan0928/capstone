            ...
            <div class="qr-section">
                @if ($qrCodePath)
                    <div class="qr-instruction">
                        ...
                        <p>Your personalized QR code has been generated and is attached to this email.</p>
                        
                        <div class="qr-steps">
                            <p><strong>To access your QR code:</strong></p>
                            <ol>
                                <li><span class="download-icon">⬇️</span> <strong>Scroll down</strong> to the bottom of this email</li>
                                <li><span class="download-icon">📎</span> Look for the attachment named <strong>"qr-code.png"</strong></li>
                                <li><span class="download-icon">💾</span> <strong>Download</strong> the QR code image to your device</li>
                                <li><span class="download-icon">📲</span> <strong>Save it</strong> to your phone's gallery or files</li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="note">
                        ...
                        <ul>
                            <li>Present the QR code at the front desk when you arrive</li>
                            <li>Staff will scan it to verify your booking</li>
                            <li>This serves as your digital entry pass</li>
                            <li>Keep it accessible throughout your visit</li>
                        </ul>
                    </div>
                @else
                    <div class="error">
