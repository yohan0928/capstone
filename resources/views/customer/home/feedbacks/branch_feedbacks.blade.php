...
@section('title', 'Reviews - ' . $branch->branch_name)
...
@section('content')
        ...
        <div class="container mx-auto px-3">
            <div class="max-w-4xl mx-auto">
                <div class="flex flex-col md:flex-row items-start md:items-center justify-between">
                    <div class="flex-1">
                        <h1 class="text-xl md:text-2xl font-bold text-[#4a3429] mb-2">{{ $branch->branch_name }}</h1>
                        <div class="flex flex-wrap items-center gap-2 mb-3">
                            <span class="inline-block bg-[#f5f0eb] text-[#7f5539] text-xs px-2 py-1 rounded border border-[#e6ddd4]">
                                <i class="fas fa-map-marker-alt mr-1 text-red-500"></i>{{ $branch->location }}
                            </span>
                            ...
                            <span class="inline-block bg-[#f0e6f7] text-[#7b3f9e] text-xs px-2 py-1 rounded border border-[#e6d1f0]">
                                <i class="fas fa-calendar mr-1"></i>{{ $branch->open_days }}
                            </span>
                        </div>
                        @if ($branch->features)
                            <p class="text-gray-600 text-xs"><strong class="text-[#4a3429]">Features:</strong> {{ $branch->features }}</p>
                        @endif
                    </div>
        ...
        <div class="container mx-auto px-3">
            <div class="max-w-4xl mx-auto">
                <div class="text-center mb-6">
                    ...
                    <p class="text-gray-600 text-xs">How customers rate this branch</p>
                </div>
                <div class="space-y-2">
        ...
        <div class="container mx-auto px-3">
            <div class="max-w-4xl mx-auto">
                <div class="text-center mb-6">
                    ...
                    <p class="text-gray-600 text-xs section-subtitle">What customers are saying about this branch</p>
                </div>
                            ...
                            <div
                                ...
                                <div class="flex justify-between items-start mb-3">
                                    <div class="flex items-center">
                                        <div class="w-10 h-10 bg-gradient-to-br from-[#f5f0eb] to-[#e6ddd4] rounded-full flex items-center justify-center mr-3">
                                            <span class="text-[#7f5539] font-bold text-sm">{{ strtoupper(substr($feedback->customer_name, 0, 1)) }}</span>
                                        </div>
                                        <div>
                                            <h4 class="text-sm font-semibold text-[#4a3429]">{{ $feedback->customer_name }}</h4>
                                ...
                                <div class="mb-3">
                                    <div class="flex flex-wrap gap-1 mb-2">
                                        <span class="inline-block bg-[#f5f0eb] text-[#7f5539] text-xs px-2 py-0.5 rounded border border-[#e6ddd4]">
                                            <i class="fas fa-tag mr-1"></i>{{ $feedback->serviceCategory->service_category }}
                                        </span>
                                        <span class="inline-block bg-[#e6f7f0] text-[#2e8b57] text-xs px-2 py-0.5 rounded border border-[#d1f0e1]">
                                            <i class="fas fa-concierge-bell mr-1"></i>{{ $feedback->serviceName->service_name }}
                                        </span>
                                    </div>
                                </div>
                ...
                @else
                    <div class="text-center py-8">
                        ...
                        <p class="text-gray-500 text-sm mb-4">Be the first to review this branch!</p>
                    </div>
                @endif
            </div>
        </div>
    ...
    <section class="py-8 bg-white">
        <div class="container mx-auto px-3">
            <div class="max-w-4xl mx-auto">
                <div class="text-center mb-6">
                    <h3 class="text-sm font-semibold text-[#4a3429] mb-2">Branch Statistics</h3>
