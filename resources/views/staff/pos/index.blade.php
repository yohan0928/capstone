        ...
        <main class="px-4 sm:px-6 lg:px-8 py-4">
            ...
            <div class="block lg:hidden space-y-4">
                ...
                <div x-show="showRewardsSection && selectedCustomerId" x-cloak class="bg-white rounded-xl shadow-sm border border-gray-200">
                    ...
                    <div class="p-4">
                        ...
                        <div x-show="!rewardsLoading && availableRewards.length > 0">
                            ...
                            <!-- Applied Reward Display - WITH COMPUTATION -->
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200">
                    ...
                    <!-- Order Summary - WITH REWARD COMPUTATION -->
                    <div class="border-t border-gray-200 p-4 bg-gray-50">
                        <div class="space-y-2 mb-4">
                            ...
                            <!-- Reward Discount with Tooltip - Mobile -->
                                ...
                                <div class="text-right">
                                    ...
                                    <div class="absolute right-0 bottom-full mb-2 w-64 p-3 bg-gray-800 text-white text-xs rounded-lg shadow-lg opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none z-50">
                                        ...
                                        <p class="text-gray-400 text-[10px] mt-1">
                                            <span x-show="appliedReward?.is_percentage || appliedReward?.reward_type === 'percentage_discount'">
                                                <span x-text="`${parseFloat(appliedReward?.percentage || 0)}% × ₱${parseFloat(orderSummary.subtotal).toFixed(2)}`"></span>
                                            </span>
                                            <span x-show="!appliedReward?.is_percentage && appliedReward?.reward_type !== 'percentage_discount'">
                                                <span x-text="`₱${parseFloat(appliedReward?.discount_value || 0).toFixed(2)} off`"></span>
                                            </span>
                                        </p>
                                    </div>
                                </div>
                        ...
                        <div class="flex flex-col h-full gap-4">
                                ...
                                <div x-show="showRewardsSection && selectedCustomerId" x-cloak class="bg-white rounded-xl shadow-sm border border-gray-200 flex flex-col max-h-48">
                                    ...
                                    <div class="flex-1 p-3 overflow-y-auto">
                                        ...
                                        <div x-show="!rewardsLoading && availableRewards.length > 0">
                                            ...
                                            <!-- Applied Reward Display - DESKTOP WITH COMPUTATION -->
                            ...
                            <div class="grid gap-4 flex-1 min-h-0" :class="showPayment ? 'grid-cols-2' : 'grid-cols-1'">
                                ...
                                <div class="bg-white rounded-xl shadow-sm border border-gray-200 flex flex-col h-full overflow-hidden">
                                    ...
                                    <!-- Order Summary - DESKTOP WITH REWARD COMPUTATION -->
                                    <div class="border-t border-gray-200 p-3 bg-gray-50 flex-shrink-0">
                                        <div class="space-y-1 mb-2">
                                            ...
                                            <!-- Reward Discount with Tooltip - Desktop -->
    ...
    <script>
        function posSystem() {
            return {
                ...
                baseUrls: {
                    searchProduct: '{{ route('sub_two.pos.search-product') }}',
                    processOrder: '{{ route('sub_two.pos.process-order') }}',
                    changeBranch: '{{ route('sub_two.pos.change-branch') }}',
                    getCustomerRewards: '{{ route('sub_two.pos.get-customer-rewards') }}',
                    applyReward: '{{ route('sub_two.pos.apply-reward') }}'
                },
                ...
                async applyReward() {
                    ...
                    try {
                        ...
                        if (data.success) {
                            ...
                            // Auto-add product from reward to cart
                ...
                // Methods
                getBranchName(id) {
                    if (!id) return 'Your Branch';
                    const branch = this.branches.find(b => b.id == id);
                    return branch ? branch.branch_name : 'Your Branch';
                },
