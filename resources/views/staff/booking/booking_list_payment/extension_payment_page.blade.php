...
@section('content')
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
        <!-- Back Link -->
        <a href="{{ route('sub_two.booking_lists.showBookingList') }}" class="inline-flex items-center gap-2 text-purple-900 hover:text-purple-700 font-semibold mb-6 sm:mb-8 transition-colors duration-200">
            ...
            <div class="p-4 sm:p-6 lg:p-8">
                ...
                @if (!$hasExtension)
                    ...
                    <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-6 sm:p-8 text-center">
                        ...
                        <a href="{{ route('sub_two.booking_lists.showBookingList') }}" class="inline-flex items-center justify-center px-6 py-3 bg-gray-600 hover:bg-gray-700 text-white font-semibold rounded-lg transition-colors duration-200">
                            Back to Booking List
                        </a>
                    </div>
                @else
                    ...
                    @if (!$extensionPayment || $extensionPayment->payment_status != 1)
                        <div class="bg-gray-50 rounded-lg p-4 sm:p-6 lg:p-8">
                            ...
                            <form method="POST" action="{{ route('sub_two.booking_lists.updateExtensionPayment') }}" id="paymentForm">
                                @csrf
                                ...
                                <div class="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-end mt-6 sm:mt-8">
                                    ...
                                    <button type="submit" id="submitButton"
                                            class="inline-flex items-center justify-center px-6 py-3 bg-purple-600 hover:bg-purple-700 text-white font-semibold rounded-lg transition-colors duration-200 order-1 sm:order-2 disabled:opacity-50 disabled:cursor-not-allowed">
