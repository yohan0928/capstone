...
@section('content')
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
        <!-- Back Link -->
        <a href="{{ route('sub_one.booking_lists.showBookingList') }}" class="inline-flex items-center gap-2 text-emerald-900 hover:text-emerald-700 font-semibold mb-6 sm:mb-8 transition-colors duration-200">
        ...
        <div class="bg-white rounded-xl shadow-lg overflow-hidden">
            ...
            <div class="p-4 sm:p-6 lg:p-8">
                ...
                <div class="bg-gray-50 rounded-lg p-4 sm:p-6 lg:p-8">
                    ...
                    <form method="POST" action="{{ route('sub_one.booking_lists.updateOrderPayment') }}" id="paymentForm">
                        @csrf
                        ...
                        <div class="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-end mt-6 sm:mt-8">
                            ...
                            <button type="submit" 
                                    class="inline-flex items-center justify-center px-6 py-3 bg-emerald-600 hover:bg-emerald-700 text-white font-semibold rounded-lg transition-colors duration-200 order-1 sm:order-2">
