...
@section('content')
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
        <!-- Back Link -->
        <a href="{{ route('sub_one.booking_lists.showBookingList') }}" class="inline-flex items-center gap-2 text-amber-900 hover:text-amber-700 font-semibold mb-6 sm:mb-8 transition-colors duration-200">
...
@if (!$mainPayment || $mainPayment->payment_status != 1)
    <div class="bg-gray-50 rounded-lg p-4 sm:p-6 lg:p-8">
        ...
        <form method="POST" action="{{ route('sub_one.booking_lists.updateMainPayment') }}" id="paymentForm">
            @csrf
