    ...
    <div class="container mx-auto px-4 py-8 select-text">
        ...
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('sub_one.booking_lists.showBookingList') }}"
                class="inline-flex items-center px-4 py-2 bg-amber-900 mt-4 text-white rounded-md hover:bg-amber-800 transition-colors">
                Back
            </a>
        </div>
                        ...
                        <table class="w-full min-w-[800px]">
                            ...
                            <tbody class="divide-y divide-gray-200">
                                ...
                                @if ($hasServicePayments)
                                    ...
                                    <tr class="bg-gray-50">
                                        <td class="px-6 py-4 text-sm font-semibold text-gray-900">Sub Total Service Payments</td>
                                ...
                                @if ($hasOrderPayments)
                                    ...
                                    <tr class="bg-gray-50">
                                        <td class="px-6 py-4 text-sm font-semibold text-gray-900">Sub Total Order Payments</td>
                                        <td class="px-6 py-4"></td>
                                        <td class="px-6 py-4 text-sm font-semibold text-gray-900 text-right border-t">
                            ...
                            <tbody class="divide-y divide-gray-200">
                                ...
                                @if ($booking->last_updated_by)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 bg-gray-50 text-sm font-medium text-gray-900">Last Date Updated
                                        </td>
                                        <td class="px-6 py-4 text-sm text-gray-600 select-text">
