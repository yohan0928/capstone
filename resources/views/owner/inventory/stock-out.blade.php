...
@section('content')
    <div x-data="stockOutData()" x-init="init()" class="p-4 max-w-3xl mx-auto">
        ...
        document.addEventListener('alpine:init', () => {
            Alpine.data('stockOutData', () => ({
                ...
                init() {
                    ...
                    // Pre-fill from a link on the Stock Levels page
                    ...
                    if (itemType && itemId && (itemType === 'product' || itemType === 'ingredient')) {
                        this.stockOutItems[0].item_type = itemType;
                        if (itemType === 'product') {
                            this.stockOutItems[0].product_id = Number(itemId);
                        } else {
                            this.stockOutItems[0].ingredient_id = Number(itemId);
                        }
                    }
                },
