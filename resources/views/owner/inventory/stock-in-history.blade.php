...
@section('content')
    <div x-data="stockInHistoryData()" x-init="init()" class="p-4">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200">
            <div class="px-6 py-4 border-b border-gray-200">
                <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-4">
                    <div>
                        <h2 class="text-lg font-semibold text-gray-900">All Stock In Transactions</h2>
                        <p class="text-xs text-gray-400 mt-0.5">Click the eye icon to view the items in that transaction</p>
                    </div>
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center gap-3 w-full lg:w-auto">
                        ...
                        {{-- ADD BUTTON — opens the Stock In modal instead of navigating away --}}
                        ...
                        <tr x-show="!pagedTransactions.length">
                            <td colspan="7" class="px-6 py-12 text-center">
                                <div class="text-gray-400">
                                    ...
                                    <p class="text-sm text-gray-500" x-text="hasActiveFilters ? 'Try adjusting your search or filters.' : 'Stock-in transactions will show up here.'"></p>
                                </div>
                            </td>
                        </tr>
                    </tbody>
            ...
            <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
                ...
                <div class="relative inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl sm:my-8 sm:align-middle max-w-md w-full">
                    <div class="flex items-center justify-between px-6 pt-5 pb-4 border-b border-gray-200">
                        <h3 class="text-lg font-semibold text-gray-900">Filter Stock In</h3>
        ...
        {{-- ═════════════════════════════════════
             ...
             (matches the one on the Inventory page)
        ═════════════════════════════════════════ --}}
                    ...
                    <div class="flex flex-col flex-1 min-h-0">
                        ...
                        <div class="flex-1 overflow-y-auto overscroll-contain px-4 sm:px-6 py-4">
                            ...
                            <div class="overflow-x-auto rounded-lg border border-gray-200">
                                ...
                                <div class="grid grid-cols-[5.5rem_15rem_4rem_1fr] bg-gray-50 border-b border-gray-200 text-xs font-medium text-gray-500 uppercase tracking-wider">
                                ...
                                <template x-for="(item, i) in groupedItems(viewTransaction.items)" :key="i">
                                    <div class="grid grid-cols-[5.5rem_15rem_4rem_1fr] border-b border-gray-100 last:border-b-0 text-sm"
    ...
    <script>
        document.addEventListener('alpine:init', () => {
            Alpine.data('stockInHistoryData', () => ({

                // Expect the controller to pass only type = 'stock_in' transactions
                transactions: @json($transactions ?? []),
                branches:     @json($branches ?? []),

                searchQuery: '',
                filters:      { branch_id: '', date_from: '', date_to: '' },
                draftFilters: { branch_id: '', date_from: '', date_to: '' },
                datePreset:  'all',
                showFilters: false,
                dateError:   '',
                ...
                init() {
                    ...
                    // Jump to the right page for this transaction, then scroll + open its details
                ...
                get hasModalFilters() {
                    return this.filters.branch_id !== '' || this.filters.date_from !== '' || this.filters.date_to !== '';
                },
                ...
                clearModalFilters() {
                    this.draftFilters = { branch_id: '', date_from: '', date_to: '' };
                    this.datePreset = 'all';
                    this.dateError = '';
                },
                clearAllFilters() {
                    this.searchQuery = '';
                    this.filters = { branch_id: '', date_from: '', date_to: '' };
                    this.draftFilters = { ...this.filters };
                    this.datePreset = 'all';
                    this.txnPage = 1;
                },
