...
class SeatStaffNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toArray(object $notifiable): array
    {
        return [
            ...
            'seat_uuid' => $this->seat->uuid,
            'actor_id' => $this->actor->id,
            'action' => $this->action,
            'message' => $this->getMessage(),
            'timestamp' => now()->toDateTimeString(),
            'additional_data' => $this->additionalData,
            'url' => route('sub_two.seats.showSeat', ['branch' => $this->branch->uuid, 'service_category' => $this->serviceCategory->uuid, 'service_name' => $this->serviceName->uuid]),
        ];
    }
