...
class BookingProcessNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    private function getMessage(): string
    {
        ...
        switch ($this->action) {
            case 'created':
                return "You added a booking. Please wait for it to confirm: {$bookingRefNo} | at {$branch}";
