...
class BookNowCustomerNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    private function getMessage(): string
    {
        ...
        switch ($this->action) {
            case 'created':
                return "{$actorName} created your booking: {$bookingRefNo} | {$customerName} checked in at {$branch}";

            default:
                return "Someone performed action on book now: {$bookingRefNo} | {$customerName} at {$branch}";
        }
    }
