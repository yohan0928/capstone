...
class ScanQrCodeBookingCustomerNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    private function getMessage(): string
    {
        ...
        switch ($this->action) {
            case 'checked_in':
                return "{$bookingRefNo} | You are checked in at {$branch}";

            case 'checked_out':
                return "{$bookingRefNo} | You checked out at {$branch}";
