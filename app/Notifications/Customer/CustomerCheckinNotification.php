...
class CustomerCheckinNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    private function getMessage(): string
    {
        ...
        switch ($this->action) {
            ...
            case 'extend_time':
                return "{$bookingRefNo} | You extended the booking time at {$branch}.";

            default:
                return "performed action on checkin of {$bookingRefNo} | {$customerName} at {$branch}";
        }
    }
