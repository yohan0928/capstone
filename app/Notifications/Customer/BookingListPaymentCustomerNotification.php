...
class BookingListPaymentCustomerNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    private function getMessage(): string
    {
        ...
        switch ($this->action) {
            case 'main_payment':
                return "{$actorName} updated the main payment: {$bookingRefNo} | {$customerName} paid at {$branch}";

            case 'extension_payment':
                return "{$actorName} updated the extension payment: {$bookingRefNo} | {$customerName} paid at {$branch}";

            default:
                return "Someone performed action on the payment: {$bookingRefNo} | {$customerName} at {$branch}";
        }
    }
