...
class ProductIngredientNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toArray(object $notifiable): array
    {
        return [
            ...
            'url' => route('sub_one.product_ingredients.showProductIngredient', ['product' => $this->products->uuid]),
        ];
    }
