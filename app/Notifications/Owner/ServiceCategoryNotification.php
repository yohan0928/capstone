...
class ServiceCategoryNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toArray(object $notifiable): array
    {
        return [
            ...
            'url' => route('sub_one.service_categories.showServiceCategory', ['branch' => $this->branch->uuid]),
        ];
    }
