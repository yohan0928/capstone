...
class LoyaltyTierController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('owner.loyalty.tiers', compact('loyaltyTiers', 'branches', 'redeemableItems', 'tiersData'));
    }
    ...
    /**
     * Get tier data for editing - FIXED
     */
    public function getTierData($id)
    {
        try {
            ...
            if (!$owner) {
                Log::warning('No authenticated owner found');
                return response()->json([
                    'success' => false,
